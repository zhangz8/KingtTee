...
<!-- Bootstrap Core CSS -->
<link
	href="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/bower_components/bootstrap/dist/css/bootstrap.min.css"
	rel="stylesheet">

<!-- MetisMenu CSS -->
<link
	href="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/bower_components/metisMenu/dist/metisMenu.min.css"
	rel="stylesheet">

<!-- Timeline CSS -->
<link
	href="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/dist/css/timeline.css"
	rel="stylesheet">

<!-- Custom CSS -->
<link
	href="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/dist/css/sb-admin-2.css"
	rel="stylesheet">

<!-- Morris Charts CSS -->
<link
	href="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/bower_components/morrisjs/morris.css"
	rel="stylesheet">

<!-- Custom Fonts -->
<link
	href="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/bower_components/font-awesome/css/font-awesome.min.css"
...
<body>
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand"
					href="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/pages/index.html">SB
					Admin v2.0</a>
			</div>
			<!-- /.navbar-header -->
			...
			<ul class="nav navbar-top-links navbar-right">
				...
				<li class="dropdown"><a class="dropdown-toggle"
					...
					<ul class="dropdown-menu dropdown-user">
						...
						<li class="divider"></li>
						<li><a
							href="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/pages/login.html"><i
			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a
							href="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/pages/index.html"><i
								class="fa fa-dashboard fa-fw"></i> Dashboard</a></li>
						<li><a href="#"><i class="fa fa-bar-chart-o fa-fw"></i>
								Charts<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<li><a
									href="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/pages/flot.html">Flot
										Charts</a></li>
								<li><a
									href="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/pages/morris.html">Morris.js
										Charts</a></li>
							</ul> <!-- /.nav-second-level --></li>
						<li><a
							href="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/pages/tables.html"><i
								class="fa fa-table fa-fw"></i> Tables</a></li>
						<li><a
							href="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/pages/forms.html"><i
								class="fa fa-edit fa-fw"></i> Forms</a></li>
						<li><a href="#"><i class="fa fa-wrench fa-fw"></i> UI
								Elements<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<li><a
									href="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/pages/panels-wells.html">Panels
										and Wells</a></li>
								<li><a
									href="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/pages/buttons.html">Buttons</a></li>
								<li><a
									href="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/pages/notifications.html">Notifications</a></li>
								<li><a
									href="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/pages/typography.html">Typography</a></li>
								<li><a
									href="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/pages/icons.html">
										Icons</a></li>
								<li><a
									href="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/pages/grid.html">Grid</a></li>
							</ul> <!-- /.nav-second-level --></li>
						...
						<li><a href="#"><i class="fa fa-files-o fa-fw"></i>
							...
							<ul class="nav nav-second-level">
								<li><a
									href="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/pages/blank.html">Blank
										Page</a></li>
								<li><a
									href="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/pages/login.html">Login
										Page</a></li>
							</ul> <!-- /.nav-second-level --></li>
					</ul>
				</div>
	...
	<!-- jQuery -->
	<script
		src="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/bower_components/jquery/dist/jquery.min.js"></script>

	<!-- Bootstrap Core JavaScript -->
	<script
		src="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>

	<!-- Metis Menu Plugin JavaScript -->
	<script
		src="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/bower_components/metisMenu/dist/metisMenu.min.js"></script>

	<!-- Morris Charts JavaScript -->
	<script
		src="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/bower_components/raphael/raphael-min.js"></script>
	<script
		src="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/bower_components/morrisjs/morris.min.js"></script>
	<script src="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8//js/morris-data.js"></script>
	<!-- Custom Theme JavaScript -->
	<script
		src="${ctx}/assets/startbootstrap-sb-admin-2-1.0.8/dist/js/sb-admin-2.js"></script>
